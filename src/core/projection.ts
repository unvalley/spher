...
export type OrbaRotation = {
  x: number;
  y: number;
};

export const projectItems = <TItem extends OrbaItemBase,>(
  items: PositionedItem<TItem>[],
  rotation: OrbaRotation,
  zoom: number,
...
export const selectInsideVisibleItemIds = <TItem extends OrbaItemBase>(
...
const getInsideCollisionRadius = <TItem extends OrbaItemBase>(
